...
return 'اول من يكتب هذا العدد يفوز ↤︎`'..(redis:get(nk..':Set_Smile:'..msg.chat_id_))..'`'
else
return '️اول من يكتب هذه السمايل يفوز ↤︎    `'..(redis:get(nk..':Set_Smile:'..msg.chat_id_))..'`'
end
end
...
redis:set(nk.."GAME:CHER"..msg.chat_id_,'شجاع') 
elseif SENDTEXT:find('حي') then
redis:set(nk.."GAME:CHER"..msg.chat_id_,'حي') 
elseif SENDTEXT:find('نشيط') then
redis:set(nk.."GAME:CHER"..msg.chat_id_,'نشيط') 
...
redis:set(nk.."GAME:CHER"..msg.chat_id_,'مو ممنوع') 
...
local salem ={ 
'\n ★ ممكن توضح ليش غيرت اسمك',
'\n ★ ايش هذا الاسم'..lsalem.. ' \n خليه على الاول \n '..rsalem..'',
'\n.★ ليش غيرت اسمك عزيزي',
'\n ★ تعال ياقلب ماكان اسمك'..rsalem..' ولا انا غلطان',
'\n ★ غيرت اسمك '..rsalem..' تم اكتشافك',
'\n ★ ليش غيرت اسمك عزيزي'
}
